...
Hallucination remains a central challenge for MLLMs.
Although different studies adopt varying terminology and perspectives,
a broad consensus has emerged on the underlying concepts.
...
forming a progression from shallow perception to deeper scene understanding;
...
Synthesizing these frameworks
and given that the experiments in this report
primarily target visual question answering
and image-text reasoning,
...
or contains flaws in the reasoning process.}
\end{quote}
...
Such errors---in particular numerical reasoning failures---are
the primary source of logical hallucinations in MathVista
